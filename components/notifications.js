    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.navBar}>
          ...
          <Text style={styles.navBarHeader}>Notifications</Text>
        ...
        <View style={{flexDirection: 'row'}}>
            ...
            <TouchableOpacity onPress={() => navigate('Notifications')}>
              <Image source={require('./../images/Notifi_Btn_nrm.png')}  style={{ height: 40, backgroundColor: '#ffc04c'}} resizeMode={Image.resizeMode.contain} />
            </TouchableOpacity>
